...
def main():
    ...
    for i, test_case in enumerate(test_cases):
        ...
        print("\nTest case {}:\nChecking whether {} overlaps {}".format(i, *test_case), end=' ') # spread the two Line objects in the test_case tuple into the positional parameters of format as their str representation
